...
import { formatCurrency, getDateDifference, getFormattedDate } from "@/src/shared/utils/utils";
import AttachMoneyIcon from "@mui/icons-material/AttachMoney";
import AddBusinessIcon from "@mui/icons-material/AddBusiness";
import { useUser } from "@/src/context/UserContext";
import { useStores } from "@/src/features/admin/hooks/useStores";
import { useTenantInfo } from "@/src/features/tenant/hooks/useTenantInfo";
import { useDepartments } from "@/src/features/catalog/hooks/useDepartments";
import { getInvestment, resetStoreStock } from "@/src/features/admin/api/stores";
import { useUserManagement } from "@/src/shared/hooks/useUserManagement";
import EditUserModal from "@/src/shared/ui/UserModals/EditUserModal";
import ChangePasswordModal from "@/src/shared/ui/UserModals/ChangePasswordModal";
import { CustomSpinner } from "@/src/shared/ui/Spinner/Spinner";
import { UI_TEXT } from "@/src/shared/constants";
import Swal from "sweetalert2";
import { getStoreColumns, getStorageColumns, getTotalColumns, filterColumns, filterStorageColumns, filterTotalColumns } from "@/src/features/admin/components/StoreList/StoreList.columns";
import CustomModal from "@/src/shared/ui/Modal/Modal";
import CreateStoreModal from "@/src/features/admin/components/StoreList/CreateStoreModal";
import { useModal } from "@/src/shared/hooks/useModal";
import { useCanCreateStore } from "@/src/features/admin/hooks/useCanCreateStore";
import { useQueryClient } from "@tanstack/react-query";
import { createMercadoPagoPreference } from "@/src/features/tenant/api/mercadopago";
import { showError } from "@/src/shared/utils/alerts";
import mercadoPagoLogo from "@/src/shared/assets/mercadopago-logo.svg";
