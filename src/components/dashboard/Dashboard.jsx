    ...
    <div>
      <div className="custom-section">
        ...
        <Row>
          ...
          <Col md={6}>
            <LineChart title={"Ventas por hora"} taskId={tasks?.task3} labels={["0:00", "1:00", "2:00", "3:00", "4:00", "5:00", "6:00", "7:00", "8:00", "9:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00", "23:00"]} yText={"Ingresos"} xText={"Dias"}/>
          </Col>
          ...
          <Col md={3}>
            <DoughnutChart title={"Ventas por tienda(%)"} taskId={tasks?.task5}/>
          </Col>
        </Row>
      </div>
    </div>
