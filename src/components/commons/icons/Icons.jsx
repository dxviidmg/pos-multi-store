...
export const RemoveInCartIcon = () => {
  return (
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-dash-circle" viewBox="0 0 16 16">
...
export const CashIcon = () => {
  return (
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-cash-coin" viewBox="0 0 16 16">
